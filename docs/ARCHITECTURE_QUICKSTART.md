...
- Numbered registers: 0 holds the last yank; 1..9 rotate on line-wise deletes/changes (most recent in 1).
- Small delete register (-): character-wise deletes/changes (x, dw when not spanning lines) write here.
