    ...
    pub fn start_command_completion(&mut self, input: &str) {
        ...
        self.command_completion
            .set_context(crate::features::completion::CompletionContext {
                ...
                number: self.config.display.show_line_numbers,
                relativenumber: self.config.display.show_relative_numbers,
                cursorline: self.config.display.show_cursor_line,
                ...
                incsearch: self.config.behavior.incremental_search,
                wrap: self.config.behavior.wrap_lines,
                linebreak: self.config.behavior.line_break,
                undofile: self.config.editing.persistent_undo,
                backup: self.config.editing.backup,
                swapfile: self.config.editing.swap_file,
                autosave: self.config.editing.auto_save,
                laststatus: self.config.interface.show_status_line,
                showcmd: self.config.interface.show_command,
                syntax: self.config.display.syntax_highlighting,
                percentpathroot: self.config.interface.percent_path_root,
            });
